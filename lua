...
function Library:object(class, properties)
	...
	function methods:tooltip(text)
		...
		local tooltipArrow = tooltipContainer:object("ImageLabel", {
			Image = "http://www.roblox.com/asset/?id=8476348446",
...
function Library:create(options)
	...
	local creditsTab = Library.tab(mt, {
		...
		Icon = "http://www.roblox.com/asset/?id=8569322835"
	})

	rawset(mt, "creditsContainer", creditsTab.container)

	creditsTab:credit{Name = "Abstract", Description = "no one"}
	creditsTab:credit{Name = "Deity", Description = "no one"}
...
function Library:toggle(options)
	...
	local on = "http://www.roblox.com/asset/?id=8569322835"
	local off = "http://www.roblox.com/asset/?id=8569322835"
